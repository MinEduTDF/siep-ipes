<div class="col-md-4">
        ...
        <span class="name"><span class="glyphicon glyphicon-info-sign"></span> <b>Sección:</b> <?php echo $this->Html->link($inscripcionsMateria['Materia']['alia'], array('controller' => 'cursos', 'action' => 'view', $inscripcionsMateria['Materia']['id']));?></span><br/>
